...
$ I = \{1=\text{Anton}, 2=\text{Berta}\} $ verfügt jeweils über zwei \emph{reine Strategien}
...
Jede Strategiekombination $ s $ bestimmt ein \emph{Ergebnis} $ o_i $. Die Menge aller möglichen
...
\begin{definition}
	...
	Eine \emph{endliche extensive Form mit perfekter Information} (auch \emph{extensive-form game frame}) besteht aus den folgenden Bestandteilen:%
	\begin{itemize}[
		itemsep=0pt,
		topsep=0pt,
		parsep=0pt,
...
\begin{definition}
	...
	Für jeden Spieler $i \in I$ ist eine Präferenzrelation $\succeq_i$ auf $O$ gegeben, die üblicherweise durch eine ordinale Nutzenfunktion $U_i : O \to \mathbb{R}$ dargestellt werden kann.
\end{definition}

Zur Veranschaulichung der zuvor eingeführten Definitionen werden die initialen Züge des Spiels Othello betrachtet und ein entsprechender Spielbaum konstruiert.
...
\begin{figure}[hbt]
	...
	\makebox[\textwidth][c]{%
		...
		\begin{minipage}[c]{0.32\textwidth}
			...
			\vfill
			\par\vspace{0.4em}
			{\footnotesize (i) Zuvor Startaufstellung}
		\end{minipage}%
