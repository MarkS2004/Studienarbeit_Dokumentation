...
\begin{table}[hbt]	
	\centering
	\captionabove[Ausgänge des Spiels Golden Balls]{Mögliche Ausgänge des Spiels Golden Balls.}
	...
	\begin{tabular}{c c|c c c c}
		 ...
		 & & \multicolumn{2}{c|}{kooperiert ($s_{21}$)} & \multicolumn{2}{c|}{defektiert ($s_{22}$)}\\ \hline
		\multirow{4}{*}{\large \textcolor{red}{Berta} \,} & \multirow{2}{*}{kooperiert ($s_{11}$)} & \multirow{2}{*}{$o_1:$} & \multicolumn{1}{l|}{\textcolor{blue}{Anton erhält 50\,€,}} & \multirow{2}{*}{$o_3:$} & \multicolumn{1}{l|}{\textcolor{blue}{Anton erhält 100\,€,}} \\
		 & & & \multicolumn{1}{l|}{\textcolor{red}{Berta erhält 50\,€.}} & & \multicolumn{1}{l|}{\textcolor{red}{Berta erhält 0\,€.}} \\ \cline{2-6}
		 & \multirow{2}{*}{defektiert ($s_{12}$)} & \multirow{2}{*}{$o_2:$} & \multicolumn{1}{l|}{\textcolor{blue}{Anton erhält 0\,€,}} & \multirow{2}{*}{$o_4:$} & \multicolumn{1}{l|}{\textcolor{blue}{Anton erhält 0\,€,}}  \\
...
Die Darstellung der Spielsituation in der Form \( \Gamma^{\prime} = (I, S, O) \) wird als \textbf{Spielform}
...
\( f : S \rightarrow O \) beziehungsweise \( f(s) = o_i \in O \) ergänzt, die jeder Strategiekombination \( s \)
ein Ergebnis zuweist, ergibt sich die Darstellung \( \Gamma^{\prime \prime} = (I, S, O, f) \), die auch als
...
% FOrmelle Definition eines SPiels
% Weitere Darstellung eines Nutzenfunktion
