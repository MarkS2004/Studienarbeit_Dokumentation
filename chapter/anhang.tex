...
%
\addchap{B Simulationsergebnisse}
\setcounter{chapter}{2}
...
\begin{table}[H]
	\centering
	\small
	\caption[Laufzeiten in $\mu$s pro Suchtiefe für alle Algorithmen]{Laufzeiten in $\mu$s pro Suchtiefe für alle Algorithmen.}
...
\begin{table}[H]
	\centering
	\small
	\caption[Speicherverbrauch in Bytes pro Suchtiefe für alle Algorithmen]{Speicherverbrauch in Bytes pro Suchtiefe für alle Algorithmen.}
