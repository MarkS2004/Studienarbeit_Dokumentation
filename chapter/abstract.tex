...
Die vorliegende Arbeit beschäftigt sich mit der Erstellung eines Konzepts für ein Robotersystem zur Ausführung des Spiels Othello auf einer digitalen Plattform. Die Problemstellung ergibt sich aus der Herausforderung, ein System zu entwickeln, das in der Lage ist, das Spiel selbstständig regelkonform zu spielen, dabei präzise Bewegungen auf einem Tablet auszuführen und die begrenzten Ressourcen der verwendeten LEGO Education SPIKE Prime Hardware effizient zu nutzen. Zusätzlich muss ein Sicherheitsbereich eingehalten und die Interaktion mit der digitalen Schachuhr zur Spielzugübergabe zuverlässig realisiert werden.
...
This thesis deals with the creation of a concept for a robot system to play the game Othello on a digital platform. The problem arises from the challenge of developing a system that is capable of playing the game independently in accordance with the rules, while executing precise movements on a tablet and making efficient use of the limited resources of the LEGO Education SPIKE Prime hardware used. In addition, a safety area must be maintained and interaction with the digital chess clock for handing over moves must be reliably implemented.
