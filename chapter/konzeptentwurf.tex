...
Wie in den Spielregeln festgelegt, beginnt der Spieler Schwarz, der zuvor ausgelost wird. Anschließend werden die Spielzüge abwechselnd ausgeführt, wobei die maximale Dauer eines einzelnen Spielzugs auf \SI{2}{\minute} begrenzt ist. Diese Zeitvorgabe kann im Verlauf des Projekts im gegenseitigen Einvernehmen angepasst werden.
Zur Übergabe der Spielzüge zwischen den Robotern wird eine digitale Schachuhr verwendet \autocite{seanoconnorMultiPlayerChess2021}. Diese ist internetbasiert, erfordert keine Registrierung und kann über mehrere Endgeräte synchronisiert werden. Die Schachuhr wird auf einem Mobiltelefon geöffnet. Die Positionierung des Mobiltelefons sowie die Skalierung der Internetseite obliegen den jeweiligen Teams.
...
Die Interaktion des Roboters mit dem Tablet erfolgt ausschließlich über einen Touchstift oder vergleichbare mechanische Betätigungsmechanismen. Die konkrete technische Umsetzung, beispielsweise hinsichtlich Form, Halterung oder Betätigungsart, ist nicht standardisiert und obliegt den jeweiligen Teams.
Für den Aufbau des Roboters sind ausschließlich ausgewählte Bauteile aus dem LEGO\textsuperscript{\textregistered} SPIKE Prime-Baukastensystem zu verwenden. Ergänzend dürfen wenige selbst gefertigte Bauteile aus dem 3D-Druck eingesetzt werden, etwa zur Befestigung des Touchstifts. Stationäre Komponenten des Roboters dürfen auf der Tischfläche im Ruhezustandsbereich fixiert werden, beispielsweise mittels Klettband, Klebeband oder vergleichbarer Befestigungsmittel.
