...
\newcommand{\titel}{Konzeptioneller Entwurf eines Reversi spielenden Roboters auf Basis von LEGO\textsuperscript{\textregistered} SPIKE unter begrenzten Rechenressourcen}
