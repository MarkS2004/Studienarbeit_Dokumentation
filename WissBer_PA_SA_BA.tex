...
beforeskip=0.5ex,   % Abstand vor \paragraph
]{paragraph}
%------
...
\newcommand{\titel}{Konzeptioneller Entwurf eines Othello spielenden Roboters auf Basis von LEGO\textsuperscript{\textregistered} SPIKE unter begrenzten Rechenressourcen}
...
\newcommand{\autorA}{Marc Bernad}
\newcommand{\autorB}{Mark Schaab}
\newcommand{\autor}{\autorA, \autorB}
\newcommand{\bearbeitungszeitraum}{29.09.2025 - 12.01.2026}
\newcommand{\matrikelnrA}{2226337}
\newcommand{\matrikelnrB}{6790654}
\newcommand{\kurs}{TEA23}
\newcommand{\abgabedatum}{\today}
\newcommand{\betreuer}{Prof. Dr. Thorsten Kever}
...
style=ieee, %% Zitierstil (siehe Dokumentation) style=numeric oder style=alphabetic oder authortitle oder authoryear
%verbose-inote,
...
\usepackage{amsmath,amssymb} 			% Ergänzungen für Formeln
...
\newtheoremstyle{defcolon}%
{\topsep}{\topsep}% Abstand oben/unten
{\normalfont}% Body-Font
{}% Einzug
{\bfseries}% Head-Font
{:}% Satzzeichen nach Kopf (hier :)
{.5em}% Abstand nach Kopf
{}% Head-Spec

\theoremstyle{defcolon}
...
\include{chapter/stand-der-technik}
